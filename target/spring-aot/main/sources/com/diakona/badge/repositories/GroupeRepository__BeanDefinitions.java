...
/**
 * Bean definitions for {@link GroupeRepository}.
 */
@Generated
public class GroupeRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'groupeRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getGroupeRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'groupeRepository'.
   */
  public static BeanDefinition getGroupeRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, GroupeRepository.class, Groupe.class, String.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.diakona.badge.repositories.GroupeRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.GroupeRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.diakona.badge.repositories.GroupeRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getGroupeRepositoryInstanceSupplier();
